...
from wallethub.entity.artifact_entity import ModelPusherArtifact, DataIngestionArtifact,ModelEvaluationArtifact
from wallethub.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
from wallethub.entity.config_entity import DataIngestionConfig,ModelEvaluationConfig
...
from wallethub.components.data_transformation import DataTransformation
from wallethub.components.model_trainer import ModelTrainer
from wallethub.components.model_evaluation import ModelEvaluation
from wallethub.components.model_pusher import ModelPusher
import os, sys
from collections import namedtuple
from datetime import datetime
import pandas  as pd
from wallethub.constants import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME

Experiment = namedtuple("Experiment",["experiment_id","initialization_timestamp","artifact_time_stamp",
"running_status","start_time","stop_time","execution_time","message","experiment_file_path","model_name","accuracy","rmse","mae","mape","is_model_accepted"])
...
class Pipeline(Thread):
    ...
    experiment:Experiment=Experiment(*([None]*15))
    ...
    def run_pipeline(self):
        try:
            ...
            model_name = model_trainer_artifact.model_name,
            accuracy=model_trainer_artifact.model_accuracy,
            rmse = model_trainer_artifact.model_rmse,
            mae = model_trainer_artifact.model_mae,
            mape = model_trainer_artifact.model_mape ,
            )
            logging.info(f"Pipeline experiment: {Pipeline.experiment}")
            self.save_experiment()
        except Exception as e:
